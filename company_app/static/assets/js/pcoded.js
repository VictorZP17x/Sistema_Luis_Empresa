...
function layout_theme_sidebar_change(value) {
  if (value == "true") {
    ...
    if (control) {
      document
        .querySelector(".sidebar-theme .btn.active")
        .classList.remove("active");
      document
        .querySelector(".sidebar-theme .btn[data-value='true']")
    ...
    if (control) {
      document
        ...
        .classList.remove("active");
      document
        .querySelector(".sidebar-theme .btn[data-value='false']")
        .classList.add("active");
    }
  }
}
  ...
  if (layout == "dark") {
    ...
    if (
      document.querySelector(
        '[data-pc-layout="horizontal"] .pc-sidebar .m-header .logo-lg'
      )
    ) {
      document
        .querySelector(
    ...
    if (document.querySelector(".auth-wrapper a>img")) {
      document
        .querySelector(".auth-wrapper a>img")
        .setAttribute("src", "../assets/images/logo-white.svg");
    }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Función para ajustar la clase según el estado del sidebar
  ...
  // Observa cambios en las clases del sidebar
  var observer = new MutationObserver(adjustContent);
